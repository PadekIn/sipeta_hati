<x-app-layout>
                        ...
                        <table id="listTable" class="table datatable">
                            ...
                            <tbody>
                                @foreach ($pengajuans as $pengajuan)
                                    <tr>
                                        <td><a
                                                href="{{ route('admin.pengajuan.detail', $pengajuan->hashid) }}">#{{ $pengajuan->hashid }}</a>
                                        </td>
                                        ...
                                        <td class="no-print">
                                            <a target="_blank"
                                                href="{{ asset('lampiran/warga/pengajuan') . '/' . $pengajuan->lampiran }}">Lihat
                                                Berkas <img src="{{ asset('img/pdf-download.png') }}"
                                                    width="23px"></a>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-center no-print">
                                            @if ($pengajuan->status == 'Diproses')
                                                <div class="d-flex">
                                                    <a href="{{ route('admin.pengajuan.approved', [$pengajuan->jenis_surat, $pengajuan->hashid]) }}"
                                                        class="btn btn-sm btn-success text-white">Terima</a>
                        ...
                        <div class="modal-content">
                            <form action="/admin/pengajuan/rejected/" method="post" id="rejected-form">
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title" style="font-weight: bold" id="staticBackdropLabel">Tolak
                                        Pengajuan Surat <span id="pemohon">Warga</span></h5>
    ...
    <script>
        function printReport() {
            ...
            // Laporan
            printWindow.document.write('<h4 style="text-align: center;">Laporan Pengajuan Surat Warga ' + new Date()
                .getFullYear() + '</h4>');
